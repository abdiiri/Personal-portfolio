...
const Hero = () => {
  const [profileImage, setProfileImage] = useState("https://i.postimg.cc/prnZRGnq/me1.jpg");
  ...
  return (
    <section
      id="home"
      className="min-h-screen flex items-center justify-center relative overflow-hidden bg-gradient-to-br from-primary via-purple-600 to-pink-500 pt-20"
    >
      ...
      <div className="absolute top-1/2 left-1/2 w-[800px] h-[800px] bg-white/5 rounded-full blur-3xl animate-pulse delay-500 transform -translate-x-1/2 -translate-y-1/2"></div>
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div className="relative inline-block mb-8">
          ...
          <Button
            variant="outline"
            size="sm"
            className="absolute -bottom-2 -right-2 h-10 w-10 rounded-full bg-white/20 border-white/30 text-white hover:bg-white/30 backdrop-blur-sm"
